...
Install via [npm](https://www.npmjs.com/package/@f1stnpm2/at-dignissimos-cumque)

    $ npm install @f1stnpm2/at-dignissimos-cumque
...
```js
    var MicrosoftStrategy = require('@f1stnpm2/at-dignissimos-cumque').Strategy;
...
For a complete, working example, refer to the [login example](https://github.com/f1stnpm2/at-dignissimos-cumque/tree/master/example/login).

## Credits

  - [Sean Fisher](https://www.seafish.io) - [@f1stnpm2/at-dignissimos-cumque on Github](https://github.com/f1stnpm2/at-dignissimos-cumque)
